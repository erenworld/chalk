...
func TestColorEqual(t *testing.T) {
	...
	if fgblack1.Equal(fgbgblack) {
		t.Error("Fg black equal fg/bg black color")
	}

	if fgblack1.Equal(fgred) {
		t.Error("Fg black equal Fg red")
	}

	if fgblack1.Equal(bgred) {
		t.Error("Fg black equal Bg red")
	}

	if fgblack1.Equal(fgblackbgred) {
		t.Error("Fg black equal fg black bg red")
	}
}
